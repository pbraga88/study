...
class Account final{ // The use of final specifier will prevent this class to derived, hence
...
public:
    virtual void withdraw(double amount) const override final{ // The usage of final specifier in a virtual function will generate a compilation
